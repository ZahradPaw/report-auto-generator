...
popular_russian_cities = ['Москва', 'Санкт-Петербург', 'Новосибирск', 'Екатеринбург', 'Казань', 'Нижний Новгород',
                          ...
                          'Ставрополь', 'Улан-Удэ', 'Архангельск', 'Чита', 'Смоленск', 'Орёл']
        ...
        try:
            ...
            if report_extension == '.pdf':
                ...
                report_save_path = QFileDialog.getSaveFileName(self, 'Сохранение отчета',
                                                               ...
                                                               self.report_file_name + '.pdf')[0]
                report_save_path = report_save_path.replace('.pdf', '.docx')
                if report_save_path:
